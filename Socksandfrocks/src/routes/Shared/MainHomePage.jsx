    ...
    return(
      <div>
        ...
        <div class="grid grid-cols-2 flex flex-wrap w-6/12 items-center p-8 bg-gray-100 border-gray-200 border-8 content-center centerDiv shadow-lg">
              ...
              <button type="button" class= "p-4 rounded-full bg-yellow-400 center" onClick={() => {setisHomeVisible(false), setIsRandomVisible(false), setIsCuratedVisible(true), setIsManualVisible(false)}}><span style={{ fontWeight: 'bold' }}>Try It Now!</span></button>
        </div>
        <div><p>&nbsp;</p></div>
        <div class="grid grid-cols-2 flex flex-wrap w-6/12 items-center p-8 bg-gray-100 border-gray-200 border-8 content-center centerDiv shadow-lg">
              <p>&nbsp;</p>
              ...
              <p>&nbsp;</p>
              <button type="button" class= "p-4 rounded-full bg-yellow-400 center" onClick={() => {setisHomeVisible(false), setIsRandomVisible(false), setIsCuratedVisible(false), setIsManualVisible(true)}}><span style={{ fontWeight: 'bold' }}>Try It Now!</span></button>
        </div>
        <div><p>&nbsp;</p></div>
        <div class="grid grid-cols-2 flex flex-wrap w-6/12 items-center p-8 bg-gray-100 border-gray-200 border-8 content-center centerDiv shadow-lg">
              ...
              <button type="button" class= "p-4 rounded-full bg-yellow-400 center" onClick={() => {setisHomeVisible(false), setIsRandomVisible(true), setIsCuratedVisible(false), setIsManualVisible(false)}}><span style={{ fontWeight: 'bold' }}>Try It Now!</span></button>
        </div>
        <div><p>&nbsp;</p></div>
      </div>
    );
