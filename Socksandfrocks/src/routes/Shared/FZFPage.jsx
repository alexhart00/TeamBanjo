    ...
    return(
      <div class="p-8">
        <div class="flex flex-wrap w-6/12 items-center p-8 bg-gray-100 border-gray-200 border-8 content-center centerDiv shadow-lg">
              ...
              <button type="button" class= "SFbutton center p-8" onClick={() => {setisHomeVisible(true), setIsRandomVisible(false), setIsCuratedVisible(false), setIsManualVisible(false)}}><span style={{ fontWeight: 'bold' }}>Return To Home</span></button>
        </div>
      </div>
    );
  }
