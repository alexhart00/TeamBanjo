...
function createRequestMiddleware(mf, { autoReload, proxyServer, onRequest, onResponse, onResponseError, }) {
...
function createServer(mf, { assetsDir, publicPath, autoReload = false, proxyServer, ...hooks }) {
