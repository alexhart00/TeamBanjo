...
async function preview(opts) {
    ...
    log = (message) => console.log(message), port = 3000, workerFile, assetsDir, publicPath, watch = false, buildWatchPaths, buildCommand, autoReload = false, modules = true, sourceMap = true, proxyServer, envPath, env = {}, onRequest, onResponseError, onResponse = (req, res) => {
